...
export default function WhatsAppFloat() {
  ...
  return <a href={href} target="_blank" rel="noopener noreferrer" aria-label="Chat with Mega Stride Technologies on WhatsApp" title="Chat on WhatsApp" className="group fixed bottom-5 right-5 z-[9999] grid h-14 w-14 place-items-center rounded-full border border-white/80 bg-[#25D366] text-white shadow-[0_10px_30px_rgba(37,211,102,.32)] ring-1 ring-[#25D366]/30 transition duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-[#20bd5a] hover:shadow-[0_14px_38px_rgba(37,211,102,.42)] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 sm:bottom-6 sm:right-6">
