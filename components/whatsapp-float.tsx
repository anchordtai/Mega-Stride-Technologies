...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="whatsapp-float group fixed bottom-5 right-5 z-[100] flex items-center gap-3 rounded-full border border-white/20 bg-[#25D366] px-4 py-3 text-sm font-extrabold text-white shadow-[0_18px_45px_rgba(37,211,102,.32)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:bg-[#20bd5a] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 sm:bottom-6 sm:right-6 sm:px-5"
    >
